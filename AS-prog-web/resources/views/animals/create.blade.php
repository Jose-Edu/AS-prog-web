...
@section('content')
    ...
    <form class="max-w-sm mx-auto" action="{{ url('animals') }}" method="POST">
        @csrf
        <h1 class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white mb-5">Criar Animal:</h1>
        <div class="mb-5">
